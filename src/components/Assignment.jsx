...
const Assignment = () => {
  ...
  const ModulesIcon = () => (
    <svg className="nav-icon" width="35" height="40" viewBox="0 0 35 40" fill="none">
      <path fillRule="evenodd" clipRule="evenodd" d="M19.9936 35.269L19.9822 35.2711L19.9082 35.3076L19.8874 35.3117L19.8728 35.3076L19.7988 35.2711C19.7877 35.2676 19.7794 35.2694 19.7738 35.2763L19.7697 35.2867L19.752 35.7326L19.7572 35.7534L19.7676 35.7669L19.8759 35.844L19.8915 35.8482L19.904 35.844L20.0124 35.7669L20.0249 35.7503L20.029 35.7326L20.0113 35.2878C20.0085 35.2767 20.0026 35.2704 19.9936 35.269Z" fill="currentColor"/>
