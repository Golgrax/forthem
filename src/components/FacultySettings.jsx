...
const FacultySettings = () => {
  ...
  // Estado ng mga setting - mga default na partikular sa faculty
  ...
  useEffect(() => {
    ...
    const savedSettings = localStorage.getItem('facultySettings');
    if (savedSettings) {
  ...
  const resetToDefaults = () => {
    ...
    localStorage.setItem('facultySettings', JSON.stringify(defaultSettings));
    applyAccessibilitySettings();
  };
    ...
    <div className="dashboard-container faculty-container">
      ...
      <div className="main-content">
        ...
        <div className="content-area">
          <div className="settings-container faculty-settings">
            <div className="settings-header">
              <h1 className="settings-title faculty-settings-title">Faculty Settings</h1>
              <p className="settings-subtitle faculty-settings-subtitle">Customize your faculty experience and accessibility options</p>
            </div>
                  ...
                  <div className="setting-item">
                    <label className="setting-label">
                      <input
                        ...
                        checked={settings.studentSubmissionAlerts}
                        onChange={handleInputChange}
                        className="setting-checkbox"
                      />
                      <span className="checkmark"></span>
