...
const TransfereeSettings = () => {
  ...
  const resetToDefaults = () => {
    ...
    localStorage.setItem('transfereeSettings', JSON.stringify(defaultSettings));
    applyAccessibilitySettings();
  };
  ...
  return (
    <div className="dashboard-container transferee-container">
      ...
      <div className="main-content">
        ...
        <div className="transferee-content">
          <div className="settings-container transferee-settings">
            <div className="settings-header">
              <h1 className="settings-title transferee-settings-title">Transferee Settings</h1>
              <p className="settings-subtitle transferee-settings-subtitle">Customize your transferee manager experience and accessibility options</p>
            </div>
                  ...
                  <div className="setting-item">
                    <label className="setting-label">
                      <input
                        ...
                        checked={settings.enrollmentRequests}
                        onChange={handleInputChange}
                        className="setting-checkbox"
                      />
                      <span className="checkmark"></span>
...
export default TransfereeSettings;
